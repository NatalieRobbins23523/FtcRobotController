...
@TeleOp
public class SensorAutoRedGoalOld extends LinearOpMode {
    ...
    final double RANGE_TOLERANCE = 3; // How close robot must be to target point to stop
    ...
    final Pose2D ballsInfrontClose1 = new Pose2D(DistanceUnit.INCH, 36, 31, AngleUnit.DEGREES, 0);
    final Pose2D ballsInfrontClose2 = new Pose2D(DistanceUnit.INCH, 36, 36, AngleUnit.DEGREES, 0);
    ...
    final Pose2D ballsAfterClose = new Pose2D(DistanceUnit.INCH, 36, 57.5, AngleUnit.DEGREES, 0);
...
//    final Pose2D blueAprilTagPosition = new Pose2D(DistanceUnit.INCH, -58.37, -55.64, AngleUnit.DEGREES, 133.6+90);
    ...
    final Pose2D gatePoint2 = new Pose2D(DistanceUnit.INCH, -5, 56, AngleUnit.DEGREES,90);
    final Pose2D finalParkingPoint = new Pose2D(DistanceUnit.INCH, -6.5, 36, AngleUnit.DEGREES,180);
...
//        odo.setPosition(redAprilTagPosition);
        ...
        */
        ...
        driveToPoint(gatePoint1);
        driveToPoint(gatePoint2);
