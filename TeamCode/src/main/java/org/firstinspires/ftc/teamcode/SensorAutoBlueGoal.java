...
@TeleOp
public class SensorAutoBlueGoal extends LinearOpMode {
    ...
    final Pose2D ballsInfrontFar = new Pose2D(DistanceUnit.INCH, -12, -32, AngleUnit.DEGREES, 180);
    final Pose2D ballsInfrontMiddle = new Pose2D(DistanceUnit.INCH, 12, -34, AngleUnit.DEGREES, 180);
    final Pose2D ballsInfrontClose = new Pose2D(DistanceUnit.INCH, 36, -34, AngleUnit.DEGREES, 180);
...
//    final Pose2D blueAprilTagPosition = new Pose2D(DistanceUnit.INCH, -58.37, -55.64, AngleUnit.DEGREES, 133.6+90);
    final Pose2D shooterPoint = new Pose2D(DistanceUnit.INCH, -7.5, -14, AngleUnit.DEGREES, NormalizeAngle(306));
