...
@TeleOp
public class SensorAutoBlueAudience extends LinearOpMode {
    ...
    final Pose2D ballsLoadingZoneInfront = new Pose2D(DistanceUnit.INCH, 54, -45, AngleUnit.DEGREES, 180);
    final Pose2D ballsLoadingZoneAfter = new Pose2D(DistanceUnit.INCH, 54, -68, AngleUnit.DEGREES, 180);

    //FIX SHOOTER POINT HERE
    final Pose2D shooterPoint = new Pose2D(DistanceUnit.INCH, 60, -24, AngleUnit.DEGREES, NormalizeAngle(-75));
    //is in field coordinates
    final Pose2D finalParkingPoint = new Pose2D(DistanceUnit.INCH, 54, -48, AngleUnit.DEGREES,180); //usually 225
...
//        turnBottomShooter(true, 1);
        ...
        driveToPoint(ballsLoadingZoneInfront, DEFAULT_SPEED_GAIN, DEFAULT_STRAFE_GAIN, DEFAULT_TURN_GAIN, DEFAULT_DRIVE_TIMEOUT,
                DEFAULT_HEADING_TOLERANCE, DEFAULT_RANGE_TOLERANCE, DEFAULT_VELOCITY_TOLERANCE);
        telemetry.addData("RETURNED FROM DTP BALLSINFRONTFAR", "");
        telemetry.update();
        //driveToPoint((ballsHalfFar));
        driveToPoint(ballsLoadingZoneAfter, 0.035, DEFAULT_STRAFE_GAIN, DEFAULT_TURN_GAIN, DEFAULT_DRIVE_TIMEOUT,
...
//                DEFAULT_HEADING_TOLERANCE, DEFAULT_RANGE_TOLERANCE, DEFAULT_VELOCITY_TOLERANCE);
    ...
    */
    ...
    private void initializeOdometry(GoBildaPinpointDriver odometer) {
        ...
        Pose2D pose = new Pose2D(DistanceUnit.INCH, 72, -24, AngleUnit.DEGREES, NormalizeAngle(-90));
